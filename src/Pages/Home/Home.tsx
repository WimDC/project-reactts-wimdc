  ...
  return (
    <Box
      sx={{
        ...
        textAlign: "center",
        backgroundImage:
          "url('https://myguitarlessons.co.uk/wp-content/uploads/2014/10/Kleinteilelag-Thomann-factory-620x360.jpg')",
    ...
    >
      ...
      >
        <Typography
          sx={{ fontSize: "100px", fontWeight: "bold", color: "white" }}
          variant="h2"
        >
          HOME
        </Typography>
        <Typography
          sx={{ fontSize: 40, marginBottom: 5, color: "white" }}
          variant="h3"
        >
          Stock-o-matic
        </Typography>
        ...
        <Collapse in={isExpanded}>
          <Typography>This app allows you to:</Typography>
          <Typography>- view stocks and carstocks</Typography>
          <Typography>
            - add items to or take items from a particular stock
          </Typography>
          <Typography>- view the log of all made transactions</Typography>
        </Collapse>
